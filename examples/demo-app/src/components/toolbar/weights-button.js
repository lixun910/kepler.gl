          ...
          <Dialog  onClose={this.handleClose} aria-labelledby="weights-manager-dialog" open={this.state.open}>
            ...
            <Grid container spacing={1} justify="center" alignItems="center">
              <Grid container spacing={1} justify="center" alignItems="center">
                ...
                <Grid item>
                  <Button disabled variant="contained" color="primary">Save</Button>
                </Grid>
                <Grid item>
                  <Button disabled variant="contained" color="primary">Remove</Button>
                </Grid>
              </Grid>
              <Grid container style={{ margin: '10px'}} justify="center" alignItems="center">
                <Grid item xs={12}><WeightsList weightsItems={weightsItems}/></Grid>
              </Grid>
              <Grid container spacing={1} justify="center" alignItems="center">
                <Grid item xs={1}></Grid>
                <Grid item xs={'auto'}>
                  <Button disabled size="small" variant="contained">Intersection</Button>
                </Grid>
                <Grid item xs={'auto'}>
                  <Button disabled size="small" variant="contained">Union</Button>
                </Grid>
                <Grid item xs={'auto'}>
                  <Button disabled size="small" variant="contained">Make Symmetric</Button>
                </Grid>
                <Grid item xs={'auto'}>
                  <FormControlLabel
                    control={
              ...
              <Grid container  style={{ margin: '10px'}}  spacing={1} justify="center" alignItems="center">
                <Grid item xs={12}><WeightsMetaTable weightsMeta={weightsItems[0]} /> </Grid>
              </Grid>
              <Grid container spacing={1} justify="center" alignItems="center">
                <Grid item>
                  <Button disabled variant="contained" color="default">Histogram</Button>
                </Grid>
                <Grid item>
                  <Button  disabled variant="contained" color="default">Connectivity Map</Button>
                </Grid>
                <Grid item>
                  <Button disabled variant="contained" color="default">Connectivity Graph</Button>
                </Grid>
              </Grid>
            </Grid>
            </DialogContent>
